...
import { PeriodicalCatalog } from '../../models/periodicalCatalog';
...
export class PeriodicalCatalogComponent implements OnInit {
  ...
  loadCatalog() {
    console.log("start");
    this.dataService.getCatalog(this.periodicalCatalog.skip, 4).subscribe((catalog: PeriodicalCatalog) => this.periodicalCatalog = catalog);
    console.log("end");
  }
