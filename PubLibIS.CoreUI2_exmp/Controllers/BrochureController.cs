    ...
    public class BrochureController : Controller
    {
      ...
      //  [Authorize(Roles = "admin")]
       ...
       // [Authorize(Roles = "admin")]
        ...
        //    if (!Directory.Exists(MapLocalPath(@"/Backups/Brochure")))
        //    {
        //        Directory.CreateDirectory(MapLocalPath(@"/Backups/Brochure"));
        //    }
        //    var fileName = $"{DateTime.Now:dd.MM.yyyy hh-m-ss}.json";
        //    var filePath = MapLocalPath(@"/Backups/Brochure") + $"\\{fileName}";
