...
using PubLibIS.DAL.UoW.EF;
using PubLibIS.DAL.Model;

namespace PubLibIS.DAL.UoW
{
    public class LibraryUoWEF : IUnitOfWork
    {
        private LibraryContext db;
        private bool disposed = false;

        public LibraryUoWEF(string connectionName)
        {
            db = new LibraryContext(connectionName);
        }
